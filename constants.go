...
const (
	...
	BLOCK_MAGNETITE_SEAM   = 18

	BLOCK_PLANK_WALL          = 19
	BLOCK_PLANK_SLAB          = 20
	BLOCK_AMBERFELL_CONDENSER = 21
	...
	ITEM_AMBERFELL         = 519
	ITEM_MAGNETITE_ORE     = 520
	ITEM_LODESTONE         = 521
	ITEM_AMBERFELL_CRYSTAL = 522
	...
	TEXTURE_PLANK_WALL           = 64
	TEXTURE_CARPENTERS_BENCH_TOP = 65
	...
	TEXTURE_ITEM_LODESTONE         = ITEM_LODESTONE - ITEM_FIREWOOD + TEXTURE_ACTION_WEAPON + 1
	TEXTURE_ITEM_AMBERFELL_CRYSTAL = ITEM_AMBERFELL_CRYSTAL - ITEM_FIREWOOD + TEXTURE_ACTION_WEAPON + 1
