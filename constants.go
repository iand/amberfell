...
var (
	ORE_DISTRIBUTIONS = map[byte]float64{
		BLOCK_COAL_SEAM:      OCCURRENCE_COMMON,
		BLOCK_COPPER_SEAM:    OCCURRENCE_COMMON,
		BLOCK_IRON_SEAM:      OCCURRENCE_UNCOMMON,
		BLOCK_MAGNETITE_SEAM: OCCURRENCE_VARY_RARE,
		BLOCK_ZINC_SEAM:      OCCURRENCE_RARE,
		BLOCK_QUARTZ_SEAM:    OCCURRENCE_RARE,
	}
