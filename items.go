...
func InitItems() {
	...
	items[BLOCK_AMBERFELL_PUMP] = NewBlockType(BLOCK_AMBERFELL_PUMP, "Amberfell Pump", TEXTURE_COPPER_MACH_SIDE, TEXTURE_COPPER_MACH_TOP, STRENGTH_IRON, SHAPE_CUBE, false, true, true, true, &ItemQuantity{BLOCK_AMBERFELL_PUMP, 1})
	items[BLOCK_STEAM_GENERATOR] = NewBlockType(BLOCK_STEAM_GENERATOR, "Steam Generator", TEXTURE_IRON_MACH_SIDE, TEXTURE_IRON_MACH_TOP, STRENGTH_IRON, SHAPE_CUBE, false, true, true, true, &ItemQuantity{BLOCK_STEAM_GENERATOR, 1})
	items[BLOCK_CARPENTERS_BENCH] = NewBlockType(BLOCK_CARPENTERS_BENCH, "Carpenter's Bench", TEXTURE_PLANK_WALL, TEXTURE_CARPENTERS_BENCH_TOP, STRENGTH_WOOD, SHAPE_CUBE, false, true, true, true, &ItemQuantity{ITEM_FIREWOOD, 5})
	items[BLOCK_AMBERFELL_CONDENSER] = NewBlockType(BLOCK_AMBERFELL_CONDENSER, "Amberfell Condenser", TEXTURE_PLANK_WALL, TEXTURE_CARPENTERS_BENCH_TOP, STRENGTH_WOOD, SHAPE_CUBE, false, true, true, true, &ItemQuantity{ITEM_FIREWOOD, 5})
	items[BLOCK_FURNACE] = NewBlockType(BLOCK_FURNACE, "Furnace", TEXTURE_STONE_BRICK, TEXTURE_FURNACE_TOP, STRENGTH_STONE, SHAPE_CUBE, false, true, true, true, &ItemQuantity{ITEM_RUBBLE, 4})
	items[BLOCK_FORGE] = NewBlockType(BLOCK_FORGE, "Forge", TEXTURE_STONE_BRICK, TEXTURE_FORGE_TOP, STRENGTH_STONE, SHAPE_CUBE, false, true, true, true, &ItemQuantity{ITEM_RUBBLE, 4})
