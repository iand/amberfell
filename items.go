...
func InitItems() {
	...
	items[BLOCK_COAL] = NewItem(BLOCK_COAL, "Coal", TEXTURE_COAL, TEXTURE_COAL, TEXTURE_COAL, TEXTURE_COAL, TEXTURE_COAL, TEXTURE_COAL, STRENGTH_STONE, false, true, true, &ItemQuantity{BLOCK_COAL, 1})
	items[BLOCK_IRON] = NewItem(BLOCK_IRON, "Iron Ore", TEXTURE_IRON, TEXTURE_IRON, TEXTURE_IRON, TEXTURE_IRON, TEXTURE_IRON, TEXTURE_IRON, STRENGTH_STONE, false, true, true, &ItemQuantity{BLOCK_IRON, 1})
	items[BLOCK_COPPER] = NewItem(BLOCK_COPPER, "Copper Ore", TEXTURE_COPPER, TEXTURE_COPPER, TEXTURE_COPPER, TEXTURE_COPPER, TEXTURE_COPPER, TEXTURE_COPPER, STRENGTH_STONE, false, true, true, &ItemQuantity{BLOCK_COPPER, 1})
	items[BLOCK_AMBERFELL] = NewItem(BLOCK_AMBERFELL, "Amberfell", TEXTURE_AMBERFELL_TOP, TEXTURE_AMBERFELL, TEXTURE_AMBERFELL, TEXTURE_AMBERFELL, TEXTURE_AMBERFELL, TEXTURE_AMBERFELL, STRENGTH_UNBREAKABLE, false, true, true, nil)
	items[BLOCK_CARVED_STONE] = NewItem(BLOCK_CARVED_STONE, "Carved stone", TEXTURE_STONE, TEXTURE_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, STRENGTH_STONE, false, true, true, &ItemQuantity{BLOCK_STONE, 1})
	items[BLOCK_CAMPFIRE] = NewItem(BLOCK_CAMPFIRE, "Campfire", TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, TEXTURE_CARVED_STONE, STRENGTH_LEAVES, true, true, true, &ItemQuantity{ITEM_FIREWOOD, 1})
